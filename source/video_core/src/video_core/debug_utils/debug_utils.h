...
#include <video_core/src/support/common/common_types.h>
    ...
    public:
        ...
        virtual ~BreakPointObserver() {
            ...
            if (context) {
                ...
                // it is free to continue. In particular, this is required for a proper
...
struct TextureInfo {
    ...
    int height;
    int stride;
    Pica::TextureFormat format;

    static TextureInfo FromPicaRegister(const Pica::TextureConfig& config,
                                        const Pica::TextureFormat& format);
};
 ...
 */
const Math::Vec4<u8> LookupTexture(Memory::HostMemoryBackedPages, int s, int t, const TextureInfo& info, bool disable_alpha = false);
